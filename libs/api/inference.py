...
# python demo/image_demo.py /work/dataset/culane/driver_100_30frame/05250325_0272.MP4/01050.jpg  configs/clrernet/culane/clrernet_culane_dla34.py  /work/work_dirs45/latest.pth --out-file=result.png
# python demo/image_demo.py /work/dataset/culane/driver_100_30frame/05250325_0272.MP4/01050.jpg  configs/clrernet/culane/clrernet_culane_dla34_ema.py  /work/work_dirs47/latest.pth --out-file=result.png

def inference_one_hotimage(model, args):
    ...
    plt.axis('off')
    plt.savefig(args.out_file_path, dpi=300, bbox_inches='tight', pad_inches=0)
